...
public class FragmentAddressAddEdit extends Fragment {
    EditText et_contry;
    EditText et_area;
    ...
    public static FragmentAddressAddEdit newInstance(int page) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.edit_address_add, container, false);
